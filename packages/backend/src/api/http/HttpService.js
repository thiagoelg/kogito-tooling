...
var HttpService = (function () {
  ...
  HttpService.prototype.satisfyRequirements = function () {
    return __awaiter(this, void 0, void 0, function () {
      return __generator(this, function (_a) {
        return [2, true];
      });
  ...
  HttpService.prototype.registerHttpBridge = function (bridge) {
    this.bridge = bridge;
  };
  HttpService.prototype.execute = function (endpoint, body) {
    if (!this.bridge) {
