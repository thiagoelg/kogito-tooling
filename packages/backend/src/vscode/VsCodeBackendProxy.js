  ...
  VsCodeBackendProxy.prototype.withCapability = function (serviceId, consumer) {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [4, this.tryLoadBackendExtension(false)];
          case 1:
            _a.sent();
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            ...
            return [3, 3];
          case 1:
            return [4, backendExtension.activate()];
          case 2:
            _a = _b.sent();
            _b.label = 3;
          case 3:
              ...
              case 0:
                ...
                return [
                  ...
                  vscode.env.openExternal(
                    vscode.Uri.parse("".concat(vscode.env.uriScheme, ":extension/").concat(this.backendExtensionId))
                  ),
                ];
              case 1:
                _a.sent();
