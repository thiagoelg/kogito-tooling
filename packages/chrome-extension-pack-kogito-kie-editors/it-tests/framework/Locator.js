...
var LocatorWaitAction_1 = require("./LocatorWaitAction");
var Locator = (function () {
  function Locator(driver, by) {
    this.driver = driver;
    this.by = by;
  }
  Locator.prototype.wait = function (timeout) {
    return new LocatorWaitAction_1.default(this.driver, this.by, timeout);
  };
                      ...
                      case 1:
                        ...
                        return [
                          ...
                          webElements.map(function (webElement) {
                            return new Element_1.default(webElement);
                          }),
                        ];
                    }
                  });
  ...
  Locator.prototype.getElement = function () {
    return __awaiter(this, void 0, void 0, function () {
      var _this = this;
      return __generator(this, function (_a) {
        switch (_a.label) {
                ...
                return __awaiter(_this, void 0, void 0, function () {
                  ...
                  return __generator(this, function (_a) {
                    switch (_a.label) {
                      ...
                      case 1:
                        webElement = _a.sent();
                        return [2, new Element_1.default(webElement)];
                    }
                  });
                });
