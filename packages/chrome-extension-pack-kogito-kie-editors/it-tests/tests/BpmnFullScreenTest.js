...
var TEST_NAME = "BpmnFullScreenTest";
var tools;
beforeEach(function () {
...
test(TEST_NAME, function () {
  return __awaiter(void 0, void 0, void 0, function () {
    var processUrl, bpmnPage, fullScreenPage, fullScreenEditor, fullScreenSideBar, fullScreenExplorer, _a, _b, _c, _d;
    return __generator(this, function (_e) {
      switch (_e.label) {
        case 0:
          ...
          return [4, tools.openPage(GitHubEditorPage_1.default, processUrl)];
        case 1:
          bpmnPage = _e.sent();
          return [4, bpmnPage.fullScreen()];
        case 2:
          fullScreenPage = _e.sent();
          return [4, fullScreenPage.getBpmnEditor()];
        case 3:
        ...
        case 5:
          ...
          return [4, fullScreenSideBar.openExplorer()];
        case 6:
          fullScreenExplorer = _e.sent();
          _a = expect;
          return [4, fullScreenExplorer.getNodeNames()];
        case 7:
          _a.apply(void 0, [_e.sent().sort()]).toEqual(["MyStart", "MyTask", "MyEnd"].sort());
        ...
        case 9:
          _b.apply(void 0, [_e.sent()]).toBe(processUrl + "#");
        ...
        case 11:
          bpmnPage = _e.sent();
          _c = expect;
          return [4, bpmnPage.isEditorVisible()];
        case 12:
          _c.apply(void 0, [_e.sent()]).toBe(true);
          _d = expect;
          return [4, bpmnPage.isSourceVisible()];
        case 13:
...
//# sourceMappingURL=BpmnFullScreenTest.js.map
