...
test(TEST_NAME, function () {
  return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_j) {
      switch (_j.label) {
        case 0:
          PR_WEB_PAGE = "https://github.com/tomasdavidorg/chrome-extension-pr-test/pull/3/files";
        ...
        case 6:
          ...
          return [4, gitHubPrPage.getDmnEditor()];
        case 7:
        ...
        case 11:
          navigator = _j.sent();
          _e = expect;
          return [4, navigator.getNodeNames()];
        case 12:
          _e.apply(void 0, [_j.sent().sort()]).toEqual(
        ...
        case 18:
          ...
          return [4, originalSideBar.openDecisionNavigator()];
        case 19:
          originalNavigator = _j.sent();
          _f = expect;
          return [4, originalNavigator.getNodeNames()];
        case 20:
          _f.apply(void 0, [_j.sent().sort()]).toEqual(["Decision", "InputData", "Model", "Function"].sort());
...
//# sourceMappingURL=DmnPrTest.js.map
