...
var Driver = (function () {
  ...
  Driver.init = function () {
    return __awaiter(this, void 0, void 0, function () {
      var chromeExtensionPath, chromeOptions, LOGS_DIR, chromeServiceBuilder, driver;
      var _this = this;
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            LOGS_DIR = (0, path_1.resolve)("dist-it-tests", "logs");
              ...
              ErrorProcessor_1.default.run(function () {
                return __awaiter(_this, void 0, void 0, function () {
                  return __generator(this, function (_a) {
                    switch (_a.label) {
                      case 0:
                        return [4, driver.manage().window().maximize()];
                      case 1:
                        return [2, _a.sent()];
                    }
                  });
