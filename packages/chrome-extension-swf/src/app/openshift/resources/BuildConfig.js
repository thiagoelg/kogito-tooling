...
exports.DeleteBuildConfig = exports.CreateBuildConfig = void 0;
...
var CreateBuildConfig = (function (_super) {
  ...
  CreateBuildConfig.prototype.requestBody = function () {
  ...
  CreateBuildConfig.prototype.name = function () {
    return CreateBuildConfig.name;
  };
  CreateBuildConfig.prototype.url = function () {
    return ""
      .concat(this.args.host, "/")
      .concat(API_ENDPOINT, "/namespaces/")
      .concat(this.args.namespace, "/buildconfigs");
  };
...
var DeleteBuildConfig = (function (_super) {
  ...
  DeleteBuildConfig.prototype.requestBody = function () {
    return __awaiter(this, void 0, void 0, function () {
      return __generator(this, function (_a) {
        return [2];
      });
  ...
  DeleteBuildConfig.prototype.name = function () {
    return DeleteBuildConfig.name;
  };
  DeleteBuildConfig.prototype.url = function () {
    return ""
      .concat(this.args.host, "/")
      .concat(API_ENDPOINT, "/namespaces/")
      .concat(this.args.namespace, "/buildconfigs/")
