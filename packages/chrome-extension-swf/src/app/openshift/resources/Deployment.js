      ...
      return __generator(this, function (_a) {
        return [
          ...
          '\n      kind: Deployment\n      apiVersion: apps/v1\n      metadata:\n        annotations:\n          image.openshift.io/triggers: >-\n            [{"from":{"kind":"ImageStreamTag","name":"'
            .concat(this.args.resourceName, ':latest","namespace":"')
            .concat(this.args.namespace, '"},"fieldPath":"spec.template.spec.containers[?(@.name==\\"')
            .concat(this.args.resourceName, '\\")].image","pause":"false"}]\n          ')
            .concat(Resource_1.KOGITO_WORKFLOW_FILE, ": ")
            .concat(this.args.fileName, "\n        name: ")
