...
exports.DeleteImageStream = exports.CreateImageStream = void 0;
var Resource_1 = require("./Resource");
var API_ENDPOINT = "apis/image.openshift.io/v1";
var CreateImageStream = (function (_super) {
  ...
  CreateImageStream.prototype.requestBody = function () {
  ...
  CreateImageStream.prototype.name = function () {
    return CreateImageStream.name;
  };
  CreateImageStream.prototype.url = function () {
    return ""
      .concat(this.args.host, "/")
      .concat(API_ENDPOINT, "/namespaces/")
      .concat(this.args.namespace, "/imagestreams");
  };
...
var DeleteImageStream = (function (_super) {
  ...
  function DeleteImageStream() {
    return (_super !== null && _super.apply(this, arguments)) || this;
  }
  DeleteImageStream.prototype.method = function () {
    return "DELETE";
  };
  DeleteImageStream.prototype.requestBody = function () {
    return __awaiter(this, void 0, void 0, function () {
      return __generator(this, function (_a) {
        return [2];
      });
  ...
  DeleteImageStream.prototype.name = function () {
    return DeleteImageStream.name;
  };
  DeleteImageStream.prototype.url = function () {
    return ""
      .concat(this.args.host, "/")
      .concat(API_ENDPOINT, "/namespaces/")
      .concat(this.args.namespace, "/imagestreams/")
