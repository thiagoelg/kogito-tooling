...
var KogitoEditorChannelApiImpl = (function () {
  function KogitoEditorChannelApiImpl(stateControl, file, locale, overrides) {
  ...
  KogitoEditorChannelApiImpl.prototype.kogitoGuidedTour_guidedTourUserInteraction = function (userInteraction) {
    channel_1.KogitoGuidedTour.getInstance().onUserInteraction(userInteraction);
  };
  KogitoEditorChannelApiImpl.prototype.kogitoGuidedTour_guidedTourRegisterTutorial = function (tutorial) {
    channel_1.KogitoGuidedTour.getInstance().registerTutorial(tutorial);
  };
    ...
    return __awaiter(this, void 0, void 0, function () {
      return __generator(this, function (_d) {
        return [
          2,
          (_c =
            (_b = (_a = this.overrides).kogitoWorkspace_resourceContentRequest) === null || _b === void 0
              ? void 0
              : _b.call(_a, request)) !== null && _c !== void 0
            ? _c
            : new api_2.ResourceContent(request.path, undefined),
        ];
      });
    });
  };
    ...
    return __awaiter(this, void 0, void 0, function () {
      return __generator(this, function (_d) {
        return [
          2,
          (_c =
            (_b = (_a = this.overrides).kogitoWorkspace_resourceListRequest) === null || _b === void 0
              ? void 0
              : _b.call(_a, request)) !== null && _c !== void 0
            ? _c
            : new api_2.ResourcesList(request.pattern, []),
        ];
      });
    });
  };
