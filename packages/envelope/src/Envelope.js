...
var Envelope = (function () {
  function Envelope(bus, config, envelopeClient) {
    if (config === void 0) {
      config = { containerType: api_1.ContainerType.IFRAME };
    }
    if (envelopeClient === void 0) {
      envelopeClient = new envelope_1.EnvelopeClient(
        bus,
        config.containerType === api_1.ContainerType.DIV ? config.envelopeId : undefined
      );
    }
