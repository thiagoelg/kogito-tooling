import { Catalog, DeploymentsModal, SettingsModal, Visualization, SourceCodeEditor, Console } from "../components";
                ...
                <Page>
                  <PageSection padding={{ default: "noPadding" }}>
                    ...
                    <Grid>
                      ...
                      <GridItem span={expanded.codeEditor || expanded.catalog ? 9 : 12} className={"visualization"}>
