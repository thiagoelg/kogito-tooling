describe("Try sample test", function () {
  beforeEach(function () {
    cy.visit("/");
  });
  it("should create BPMN sample", function () {
  ...
  it("should create DMN sample", function () {
    ...
    cy.getEditor().within(function () {
      ...
      cy.get("[data-i18n-prefix='DecisionNavigatorTreeView.']").should(function ($nodes) {
      ...
      cy.get(".kie-dnd-draggable:not(.hidden) .name-text").should(function ($dataTypes) {
  ...
  it("should create PMML sample", function () {
    ...
    cy.get("[aria-label='Edit file name']").should("have.value", "Sample");
    cy.getEditor().within(function () {
      cy.get(".characteristics-container div > strong").should(function ($dataTypes) {
...
//# sourceMappingURL=TrySampleTest.js.map
