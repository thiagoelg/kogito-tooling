...
exports.DeleteService = exports.CreateService = void 0;
...
var CreateService = (function (_super) {
  ...
  CreateService.prototype.requestBody = function () {
  ...
  CreateService.prototype.name = function () {
    return CreateService.name;
  };
  CreateService.prototype.url = function () {
    return "".concat(this.args.host, "/").concat(API_ENDPOINT, "/namespaces/").concat(this.args.namespace, "/services");
  };
...
var DeleteService = (function (_super) {
  ...
  DeleteService.prototype.requestBody = function () {
    return __awaiter(this, void 0, void 0, function () {
      return __generator(this, function (_a) {
        return [2];
      });
  ...
  DeleteService.prototype.name = function () {
    return DeleteService.name;
  };
  DeleteService.prototype.url = function () {
    return ""
      .concat(this.args.host, "/")
      .concat(API_ENDPOINT, "/namespaces/")
      .concat(this.args.namespace, "/services/")
      .concat(this.args.resourceName);
  };
