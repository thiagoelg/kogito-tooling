...
exports.useWorkspaceDescriptorsPromise = void 0;
...
function useWorkspaceDescriptorsPromise() {
  var _this = this;
  var workspaces = (0, WorkspacesContext_1.useWorkspaces)();
  var _a = __read((0, PromiseState_1.usePromiseState)(), 2),
    workspaceDescriptorsPromise = _a[0],
    setWorkspaceDescriptorsPromise = _a[1];
        ...
        return __generator(this, function (_a) {
          workspaces.descriptorService
            ...
            .catch(function (error) {
              if (!canceled.get()) {
                setWorkspaceDescriptorsPromise({ error: error });
              }
            });
          return [2];
        });
  ...
  (0, Hooks_1.useCancelableEffect)(
    (0, react_1.useCallback)(
      function (_a) {
        var canceled = _a.canceled;
        var broadcastChannel = new BroadcastChannel("workspaces");
        broadcastChannel.onmessage = function (_a) {
          var data = _a.data;
          console.debug("EVENT::WORKSPACES: ".concat(JSON.stringify(data)));
          refresh(canceled);
        };
        return function () {
...
exports.useWorkspaceDescriptorsPromise = useWorkspaceDescriptorsPromise;
//# sourceMappingURL=WorkspacesHooks.js.map
