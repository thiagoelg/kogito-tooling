...
import { componentOuiaProps, ouiaAttribute, OUIAProps } from "@kie-tools/runtime-tools-components/dist/ouiaTools";
...
export const PageLayout: React.FC<IOwnProps & OUIAProps> = ({
  children,
  BrandSrc,
  PageNav,
  pageNavOpen,
